...
![Model Training Output](others/terminal_output.png)

*(Note: Exceptional accuracy across all speakers, with minor edge-case misclassifications primarily centered around Speaker_08 acting as an overlap target for Speakers 06, 09, and 10.)*